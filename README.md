...
- 📈 Self-learning feedback loop — recommendations auto-scored by local Ollama model (llama3.2:3b). 
     Self-hosted users bring their own Ollama or configure any supported provider via FEEDBACK_LOOP_PROVIDER in .env
